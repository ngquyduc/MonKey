    ...
    <>
      ...
      <View style={styles.mainContainerInnerScreen}>
        ...
        <View style={{
          ...
          <View style={{flex:0.5}}>
            <TouchableOpacity 
              style={[styles.inputButton, {borderBottomLeftRadius:10, borderTopLeftRadius:10,backgroundColor:lightBlue}]} 
          ...
          <View style={{flex:0.5}}>
            <TouchableOpacity 
              style={[styles.inputButton, {borderBottomRightRadius:10, borderTopRightRadius:10,backgroundColor:darkBlue}]} 
