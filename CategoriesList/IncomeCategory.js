export default IncomeCategory = [
  ...
  {name: 'Sale', icon: 'sale', color: '#979797', isEdit: false},
  {name: 'Scholarship', icon: 'school', color: '#41d2c1', isEdit: false},
  {name: 'Coupons', icon: 'gift', color: '#fc800c', isEdit: false},
  {name: 'Stocks', icon: 'chart-line', color: '#e1fe64', isEdit: false},
